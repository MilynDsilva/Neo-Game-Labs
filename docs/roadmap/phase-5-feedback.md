...
Customers can select a game, category, and optional order, then submit a rating
and written feedback.

## Tasks

- Create feedback form and submission confirmation.
- Support categories such as bug, gameplay, purchase, download, and general.
- Associate the signed-in customer and optional game/order server-side.
...
handling, verified-purchase labels, edit history, and appeal rules before
publishing customer content.

## Exit criteria

- Feedback cannot expose another customer's orders or identity.
